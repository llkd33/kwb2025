...
// Test script to create a matching request and process PDF report
// This script tests the PDF report generation functionality with the Quram MI ID&SSA document

import { createClient } from '@supabase/supabase-js';

// Manually call config to load environment variables
dotenv.config();
