-- Remove password field from companies table (using Supabase Auth instead)
...
-- Allow companies to update their own information based on auth.uid() email
...
-- Create business_registration table if it doesn't exist
...
-- Enable RLS on business_registration table
ALTER TABLE public.business_registration ENABLE ROW LEVEL SECURITY;

-- RLS policies for business_registration table
