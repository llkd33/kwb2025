...
CREATE TABLE public.prompt_templates (
  ...
  variables JSONB, -- 템플릿에서 사용할 변수 목록
...
-- 인덱스 추가
CREATE INDEX idx_matching_requests_workflow_status ON public.matching_requests(workflow_status);
CREATE INDEX idx_pdf_uploads_matching_request_id ON public.pdf_uploads(matching_request_id);