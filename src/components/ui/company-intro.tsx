          ...
          <Card className="shadow-card mt-12">
            <CardContent className="p-8 bg-gradient-primary text-white">
              ...
              <div className="space-y-4 text-white/90 leading-relaxed">
                <p>
                  안녕하세요, 노웨어브릿지 창업자 홍동표입니다. 저희 홈페이지를 방문해 주신 여러분께 진심으로 감사드립니다.
                </p>
                <p>
                  노웨어브릿지는 국내외 AI, 핀테크, IT 분야의 기업들에게 맞춤형 비즈니스 매칭 서비스를 제공하는 전문기업입니다. 
                  저희 회사는 자체 개발한 AI 플랫폼과 글로벌 전문가 그룹을 활용하여, 여러분의 최적의 비즈니스 엠베서더로서 역할을 하고 있습니다.
                </p>
                <p>
                  노웨어브릿지의 이름처럼, 필요한 고객을 찾아내고 (KnowWhere), 연결(Bridge)함으로써 전 세계 AI, 핀테크, IT 생태계를 활성화하는 데 기여하고자 합니다. 
